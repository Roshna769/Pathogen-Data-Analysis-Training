...
#bonus-check variable frequency by sample's type
...
microbio_clean2$log_adjusted_adjusted_esbl_e_coli_cfu_adj <-microbio_clean2$log_adjusted_adjusted_esbl_e_coli_cfu_adj +1

microbio_clean2$log_adjusted_ar_ecoli_mpn_adj <-microbio_clean2$log_adjusted_ar_ecoli_mpn_adj +1  
